...
from machines.models import Machine , CaptureMachine
from captures.models import TypeParametre
...
class RapportHistoriqueMesure(models.Model):
    rapport_plan = models.ForeignKey(RapportPlanification, on_delete=models.CASCADE)
